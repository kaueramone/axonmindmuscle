const dictionary = {
  ...
  app: {
    ...
    week: {
      ...
      intro: "Vê os teus treinos guardados, edita os nomes e marca em que dias repetes cada treino. O ecrã inicial passa a abrir com o treino do dia.",
      overviewTitle: "Esta semana",
      daysPlanned: "{n} dias com treino",
      days: ["Seg", "Ter", "Qua", "Qui", "Sex", "Sáb", "Dom"],
      restDay: "—",
      routinesTitle: "Os teus treinos guardados",
      rename: "Editar nome",
      renameLabel: "Editar nome de {name}",
      nameLabel: "Nome do treino",
      saveName: "Guardar nome",
      cancelRename: "Cancelar",
      nameInvalid: "Escreve um nome com 1 a 60 caracteres.",
